...
API_NEUVATIV_GRAPHQLAPIENDPOINTOUTPUT
API_NEUVATIV_GRAPHQLAPIIDOUTPUT
API_NEUVATIV_SIGUPCODETABLETABLE_ARN
API_NEUVATIV_SIGUPCODETABLETABLE_NAME
API_NEUVATIV_USERTABLE_ARN
API_NEUVATIV_USERTABLE_NAME
ENV
REGION
Amplify Params - DO NOT EDIT *//**
* @fileoverview
 ...
 */
  const res = await Promise.all(modules.map(module => module.handler(event, context)))
  console.log('event from index: ', event)
  console.log('All handlers complete: ', res[0])
  return res[0]
}
